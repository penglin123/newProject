...
public class SideBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < letterList.size(); i++) {
            ...
            // 选中的状态
            if (i == choose) {
                paint.setColor(Color.parseColor("#4ea1e3"));
        ...
        switch (action) {
            case MotionEvent.ACTION_UP:
                ...
                if (mTextDialog != null) {
                    ...
                    Log.d("dispatchTouchEvent", "dispatchTouchEvent: 111");
                }
                Log.d("dispatchTouchEvent", "dispatchTouchEvent: 222");
                break;
                ...
                if (oldChoose != c) {
                    if (c >= 0 && c < letterList.size()) {
                        ...
                        if (mTextDialog != null) {
                            ...
                            Log.d("dispatchTouchEvent", "dispatchTouchEvent: 3333");
                        }
                        choose = c;
                        invalidate();
                    }
                }
                Log.d("dispatchTouchEvent", "dispatchTouchEvent: 444");
                break;
        }
        return true;
    }

    public void changeChoose(String s) {
        int c;
        for (c = 0; c < letterList.size(); c++) {
            if (letterList.get(c).equals(s))
                break;
        }
        choose = c;
        invalidate();
